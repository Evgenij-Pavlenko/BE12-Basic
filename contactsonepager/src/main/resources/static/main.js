...
module.exports = __webpack_require__(/*! C:\Programming\TelranFrontEnd\FE12-Angular\contactsangular\src\main.ts */"zUnb");
...
class ContactService {
    ...
    addContact(contact) {
        return this.http.post(this.contactsApi, contact, this.httpOptions);
    }
    getContacts() {
